        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        @if(Session::has('item_created_succssuflly'))
                            <div class="alert alert-success">
                                {{ Session::get('item_created_succssuflly') }}
                            </div>
                        @endif
                        <form action="{{ route('crud.store') }}" method="POST">
                            ...
                            <div class="form-group mt-4">
                               ...
                               <textarea name="details" id="details" class="form-control" cols="30" rows="3">{{ old('details') }}</textarea>
                                @error('details')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
